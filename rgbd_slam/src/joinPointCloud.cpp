...
int main( int argc, char** argv )
{
    ...
    //读取图像
    frame1.rgb = cv::imread( "../data/stitcher/color1_1.png" );
    frame1.depth = cv::imread( "../data/stitcher/depth1_1.png", -1);
    frame2.rgb = cv::imread( "../data/stitcher/color1_2.png" );
    frame2.depth = cv::imread( "../data/stitcher/depth1_2.png", -1 );
    ...
    *output += *cloud2;
    // 保存点云数据，并显示
    pcl::io::savePCDFile("../point_files/result.pcd", *output);
